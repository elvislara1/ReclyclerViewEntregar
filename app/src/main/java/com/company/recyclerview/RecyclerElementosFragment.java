...
public class RecyclerElementosFragment extends Fragment {
    ...
    private MundialViewModel elementosViewModel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        elementosViewModel = new ViewModelProvider(requireActivity()).get(MundialViewModel.class);
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                Mundial elemento = elementosAdapter.obtenerElemento(posicion);
                elementosViewModel.eliminar(elemento);

            }
        }).attachToRecyclerView(binding.recyclerView);

        elementosViewModel.obtener().observe(getViewLifecycleOwner(), new Observer<List<Mundial>>() {
            @Override
            public void onChanged(List<Mundial> elementos) {
    ...
    class ElementosAdapter extends RecyclerView.Adapter<ElementoViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ElementoViewHolder holder, int position) {
            ...
            Mundial elemento = elementos.get(position);
        ...
        public void establecerLista(List<Mundial> elementos){
